  ...
  return (
    <header className={`sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-surface/80 backdrop-blur-sm shadow-md' : 'bg-transparent'}`}>
      <div className="container mx-auto flex items-center justify-between p-6">
        ...
        <a href="mailto:sidharthsajeevkk@gmail.com" className="hidden md:inline-block px-5 py-2 text-sm font-bold text-primary border-2 border-primary rounded-full hover:bg-primary hover:text-surface transition-colors duration-300">
          Get in Touch
        </a>
      </div>
    </header>
